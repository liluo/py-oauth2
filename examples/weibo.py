...
ret = access_token.get('/2/statuses/public_timeline.json', access_token=access_token.token)
print '-' * 80
...
print '-' * 80
print 'post miniblog...'
ret = access_token.post('/2/statuses/update.json', status='now', access_token=access_token.token)
print ret.body
